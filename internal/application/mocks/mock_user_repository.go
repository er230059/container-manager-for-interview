...
// Source: internal/domain/infrastructure/user.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/infrastructure/user.go -destination=internal/application/mocks/mock_user_repository.go -package=mocks
//
