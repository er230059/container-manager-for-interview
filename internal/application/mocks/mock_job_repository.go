...
// Source: internal/domain/infrastructure/job.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/infrastructure/job.go -destination=internal/application/mocks/mock_job_repository.go -package=mocks
//
